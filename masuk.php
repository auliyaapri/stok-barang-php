...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.php">Stok Barang <i class="fa-solid fa-box-open"></i></a>
        <!-- Sidebar Toggle-->
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="post">
                                            <div class="modal-body">
                                                <select name="barangnya" class="form-select" aria-label="Default select example">
                                                    <?php
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-danger" name="barangmasuk">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
